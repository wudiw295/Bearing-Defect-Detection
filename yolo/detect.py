...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/root/autodl-tmp/yolov7-prune-main-1/runs/train_distill/slim4_all_1.3-2-12/weights/best.pt', help='model.pt path(s)')
